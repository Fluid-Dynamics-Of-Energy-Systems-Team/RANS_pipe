...
c     to be calculated
c     U,V,W             : contain velocities at former timestep
...
c********************************************************************
c   
c     advecrho calculate the extra term of the modified turbulence models (our modifications)
c     coming from the adveccion
c     
c     In formula:
c     
c       U*C   d(rho)     W*C   d(rho)
c    (------  ------  + -----  -----  )
c      2*rho    dr      2*rho    dz
c     
c     on input :
