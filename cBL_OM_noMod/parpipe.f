...
c     ****************************************************
c     This Code simulates Super_Critical Fluid in a
c     heated pipe with constant heat flux
c     ****************************************************
...
!     in case is laminar this fuction finishes here....
      if (turbmod.eq.0) return
...
c     is necessary.
c     The timestep is limited (see routine chkdt)
c     
...
c********************************************************************
c     CALCULATE advection, diffusion and Force in r-direction
...
c     *** use MIDPOINT INTEGRATION RULE ***
c     
      Bulk = 0.0
      do i=1,imax
