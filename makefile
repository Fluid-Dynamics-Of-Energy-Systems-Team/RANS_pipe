...
PROGRAM = run 
SRCS    = tm.f90 ke_tm.f90 mk_tm.f90 vf_tm.f90 sa_tm.f90 sst_tm.f90 math_module.f90 common_module.f90  eosmodels.f90  numerics.f90  fileio.f math.f mpistuff.f vfft.f main.f90
OBJS    = tm.o ke_tm.o mk_tm.o vf_tm.o sa_tm.o sst_tm.o math_module.o eosmodels.o  common_module.o param.o common.o numerics.o  fileio.o math.o mpistuff.o vfft.o main.o
