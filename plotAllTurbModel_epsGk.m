...
for j=ncases:ncases
    ...
    for i=nturb:nturb
        ...
        filename2 = sprintf('Results/Cluster/%s/%s_%s_modNew_const/',Gk,cas,mod);
        dataRans = ReadRansX(filename2,4);
        T = 1.0*(dataRans(1:1:end,5)-1)+1;
        ...
        dataRans = ReadRansX(filename2,4);
        T = 1.0*(dataRans(1:1:end,5)-1)+1;
        h4=plot(dataRans(1:1:end,1)-0.15, T,'bs','MarkerSize',4,'LineWidth',LineWidth);
        ...
        dataRans = ReadRansX(filename2,4);
        T = 1.0*(dataRans(1:1:end,5)-1)+1;
        h5=plot(dataRans(1:1:end,1)-0.15, T,'b>','MarkerSize',4,'LineWidth',LineWidth);
        ...
        if(y_plus==1)
            ...
            filename2 = sprintf('Results/Cluster/%s/%s_%s_noMod_const/',Gk,cas,mod);
            dataRans = ReadRansX(filename2,4);
            T = 1.0*(dataRans(1:1:end,5)-1)+1;
            h9=plot(dataRans(1:1:end,1)-0.15, T,'r-','MarkerSize',MarkerSize,'LineWidth',LineWidth);
            ...
            dataRans = ReadRansX(filename2,4);
            T = 1.0*(dataRans(1:1:end,5)-1)+1;
            h9=plot(dataRans(1:1:end,1)-0.15, T,'r>','MarkerSize',4,'LineWidth',LineWidth);
        
        end
        
        %if(j==1)
            filename2 = sprintf('Results/Cluster/%s/%s_%s_noMod_Prt/',Gk,cas,mod);
            dataRans = ReadRansX(filename2,4);
            T = 1.0*(dataRans(1:1:end,5)-1)+1;
            ...
            dataRans = ReadRansX(filename2,4);
            T = 1.0*(dataRans(1:1:end,5)-1)+1;
            h8=plot(dataRans(1:1:end,1)-0.15, T,'rs','MarkerSize',4,'LineWidth',LineWidth);
